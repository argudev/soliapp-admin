...
import Visualization from './tabs/viewevaluation';
import ToWritetab from './tabs/towrite';

const ViewCase = ({ data, sinriesgo, credithistory, printcase, reloadinfo, istowrite,casetyped }) => {
                ...
                <Row>
                    ...
                    <Col className="order-xl-1" xl="8">
                        ...
                        <TabContent activeTab={activeTab}>
                            ...
                            <TabPane tabId="9">
                                {istowrite && data ? <Visualization idcase={data.id} user={data.user} user_assigned={data.user_assigned} supervisor={data.user_supervisor} credit={data.credit_capacity[0]} committee_comment={data.committee_comment} reloadinfo={() => reloadinfo()} /> :
                                    <ToWritetab idcase={data.id} deletetowrite={casetyped} user={data.user} user_assigned={data.user_assigned} supervisor={data.user_supervisor} credit={data.credit_capacity[0]} committee_comment={data.committee_comment} reloadinfo={() => reloadinfo()} />}
                            </TabPane>
                        </TabContent>
