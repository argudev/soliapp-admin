...
const Verifiyinview = ({ data, paymentTypes,sinriesgo,credithistory,printcase, reloadinfo }) => {
                ...
                <Row>
                    ...
                    <Col className="order-xl-1" xl="8">
                        ...
                        <TabContent activeTab={activeTab}>
                            ...
                            <TabPane tabId="9">
                                {data && <Verification idcase={data.id} user={data.user} user_assigned={data.user_assigned} paymentTypes={paymentTypes} credit={data.credit_capacity[0]} verifiying_comment={data.verifying_comment} reloadinfo={() => reloadinfo()} />}
                            </TabPane>
                        </TabContent>
