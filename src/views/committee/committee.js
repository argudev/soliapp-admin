...
const Committeeview = ({ data, paymentTypes,sinriesgo,credithistory,printcase, reloadinfo,storesin,storehist }) => {
            ...
            <Container className="mt--7" fluid>
                <Row>
                    <Col className="order-xl-2 mb-5 mb-xl-0" xl="4">
                        <Profileclient caseid={data.id} customer={data.customer} credit={data.credit_capacity[0]} promocomment={data.promotor_comment} spvcomment={data.supervisor_comment} comcomment={data.verifying_comment} printcase={printcase} sinriesgo={sinriesgo} credithistory={credithistory} imgset={imgviewersetindex} />
                    </Col>
                    <Col className="order-xl-1" xl="8">
                        ...
                        <TabContent activeTab={activeTab}>
                            ...
                            <TabPane tabId="9">
                                {data && <Evaluation idcase={data.id} user={data.user} user_assigned={data.user_assigned} supervisor={data.user_supervisor} paymentTypes={paymentTypes} credit={data.credit_capacity[0]} committee_comment={data.committee_comment} storesin={storesin} storehist={storehist} reloadinfo={() => reloadinfo()} />}
                            </TabPane>
                        </TabContent>
